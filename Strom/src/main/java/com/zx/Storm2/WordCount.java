...
public class WordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		topo.setSpout("spout", new Spout_word());
		 topo.setBolt("bolt", new Bolt_word()).shuffleGrouping("spout");
//		topo.setBolt("bolt", new Bolt_word()).customGrouping("spout", new CustomGro1up());
		topo.setBolt("count_bolt", new Bolt_count(),2).fieldsGrouping("bolt", new Fields("word"));
