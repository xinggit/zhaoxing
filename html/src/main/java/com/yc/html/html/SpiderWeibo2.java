...
public class SpiderWeibo2 {
	...
	public static void main(String[] args) {
		...
		try {
			url = new URL(
					"http://weibo.com/a/aj/transform/loadingmoreunlogin?ajwvr=6&category=0&page=28&lefnav=0&__rnd=1503455908217");
		...
		String jsoun = body.toString().substring(body.toString().indexOf("{\"code\""),
				body.toString().lastIndexOf("\"}") + 2);
		// System.out.println(jsoun);
		parse(jsoun);
	}

	@Test
	public static void parse(String str) {
		str = str.substring(str.indexOf("\"data\":") + 10, str.lastIndexOf("\"}"));
